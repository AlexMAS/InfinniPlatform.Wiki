...
Панель - [контейнер визуальных элементов](../../KeyConcepts/Container/) в виде прямоугольной области.
Дочерние элементы панели располагаются внутри контейнера и визуально не могут выходить за его пределы.
Способ расположения элементов внутри панели зависит от их настроек выравнивания -
